    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link to="/repositories" className="btn-cyber-magenta">
  ...
  return (
    <div className="card-cyber p-6">
      <div className="flex items-center justify-between">
        ...
        <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${bgMap[color] || 'bg-neon-magenta/10'}`}>
          <Icon className="w-6 h-6" style={{ color: colorMap[color] || '#ff00ff' }} />
        </div>
      </div>
      <div className="mt-4 flex items-center gap-1">
        <span className={`text-xs font-mono ${colorMap[trendColor] || 'text-neon-green'}`}>{trend}</span>
